...
public abstract class LeapArray<T> {
    ...
    // 数组，元素为WindowWrap<T> 样本窗口，T实际为MetricBucket类型
    ...
    public WindowWrap<T> currentWindow(long timeMillis) {
        ...
        while (true) {
            ...
            if (old == null) {
                ...
                // 当前时间窗口起始时间点 < 计算出的起始时间点，说明当前的时间窗口已经过时
                /*
                 *   (old)
                 *             B0       B1      B2    NULL      B4
                ...
                if (updateLock.tryLock()) {
                    try {
                        ...
                        // 重置时间窗口(此处的理解参考官网滑动时间窗的图，是一个封闭的圆圈)
                ...
                // 当前时间窗口起始时间点 > 计算出的起始时间点，一般不会出现时间倒流，除非人为修改了系统时间
